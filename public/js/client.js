...
/**
 * Configuration for controlling the visibility of buttons in the  client.
...
function shareRoomByEmail() {
    Swal.fire({
        ...
        preConfirm: () => {
            ...
            const email = '';
            const emailSubject = `Please join our Video Chat Meeting`;
    ...
    Swal.fire({
        ...
        <div id="about">
            ...
            Email:<a 
                ...
                href="mailto:miroslav.pejic.85@gmail.com?subject= info"> 
